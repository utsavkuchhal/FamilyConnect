...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(type.equals("family"))
        {
            ...
            backendlessGeoQuery.addCategory("family");
                ...
                public void handleResponse(List<GeoPoint> response) {
                   ...
                   if(list.size() != 0) {
                       for (int i = 0; i < list.size(); i++) {
                           LatLng postionmarker = new LatLng(list.get(i).getLatitude(),list.get(i).getLongitude());
                           mMap.addMarker(new MarkerOptions()
                           .position(postionmarker)
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MapsActivity.this,"Sending Loaction",Toast.LENGTH_SHORT).show();
    ...
    public void onLocationChanged(Location location) {
        ...
        if(mMap != null)
        {
            ...
            mMap.addMarker(new MarkerOptions()
            .icon(BitmapDescriptorFactory.fromResource(R.drawable.person)).anchor(0.0f,1.0f)
                    .title("Yor last known location")
            .position(position));
